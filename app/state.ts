export type Practice = { id:string; module:number; date:string; hours:number; title:string; intention:string; evidence:string; reflection:string; feedback:string; next:string; status:string };
